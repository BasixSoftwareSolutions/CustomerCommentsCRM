...
IF NOT EXIST "C:\Program Files\OCTADEV\C3\images" GOTO MakeOCTADevC3
   	CD \C3
:MakeOCTADevC3
	MD "c:\Program Files\OCTADEV\C3\images"
...
echo y|copy "\\OCTANT03\apps$\C3apps\ClientInstall\googlemaps.html" "C:\Program Files\OCTADEV\C3\"
echo y|copy "\\OCTANT03\apps$\C3apps\ClientInstall\Google_Logo.png" "C:\Program Files\OCTADEV\C3\"
echo y|copy "\\OCTANT03\apps$\C3apps\ClientInstall\CustLetterTemplate.doc" "C:\Program Files\OCTADEV\C3\"
xcopy "\\OCTANT03\apps$\C3apps\ClientInstall\images\*.*" "C:\Program Files\OCTADEV\C3\images\" /V /C /Y /D
